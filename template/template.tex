...
\ptshowsectionorsubsection % Show subsection TOCs, or the section TOC when none exist (default: true)
\ptshowlastframe           % Show "Questions?" final slide (default: true)

% To use the independent section/subsection controls instead:
% \pthidesectionorsubsection
% \ptshowsection
% \pthidesubsection
...
\begin{frame}
    ...
    \begin{itemize}
        ...
        \item \inlinecode{\textbackslash{}ptshowsectionorsubsection} - Mostrar subsecciones o, si no existen, la sección
